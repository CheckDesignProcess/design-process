  ...
  },
  {
    ...
    content: (
      <div>
        ...
        What insights will help you ensure that the experience of the product
        will be shaped and refined to truly meet customer needs and
        expectations?
        <br />
        Recruit/source the current customers of the product and the potential
        target customers.
      </div>
    ),
  },
...
export default function ExistingProductLayout() {
